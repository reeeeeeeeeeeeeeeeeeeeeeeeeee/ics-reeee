...
public class Gilgamesh extends GameObjectEnemies implements EntityB{


	
	public Gilgamesh(double x, double y, Textures tex, Player p, Controller c,int bulletPattern, int movePattern) {
	...
	public void render(Graphics g) {
		g.drawImage(tex.gilgamesh, (int)x,(int)y, null);
	}
