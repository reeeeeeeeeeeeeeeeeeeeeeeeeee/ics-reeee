...
public class Medea extends GameObjectEnemies implements EntityB{

	public Medea(double x, double y, Textures tex, Player p, Controller c,int bulletPattern, int movePattern) {
	...
	public void render(Graphics g) {
		g.drawImage(tex.medea, (int)x,(int)y, null);
